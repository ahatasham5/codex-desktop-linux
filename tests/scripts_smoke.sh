...
SCRIPT
    ...
    assert_contains "$pkg_root/usr/share/applications/codex-desktop.desktop" "GenericName=Codex Desktop"
    assert_contains "$pkg_root/usr/share/applications/codex-desktop.desktop" "Keywords=codex;chatgpt;openai;ai;coding;"
...
SCRIPT
    ...
    assert_contains "$capture_dir/AppDir/codex-desktop.desktop" "GenericName=Codex Desktop"
    assert_contains "$capture_dir/AppDir/codex-desktop.desktop" "Keywords=codex;chatgpt;openai;ai;coding;"
...
EOF
    ...
    assert_contains "$REPO_DIR/packaging/linux/codex-desktop.desktop" "GenericName=Codex Desktop"
    assert_contains "$REPO_DIR/packaging/linux/codex-desktop.desktop" "Keywords=codex;chatgpt;openai;ai;coding;"
    ...
    assert_contains "$REPO_DIR/contrib/user-local-install/files/.local/share/applications/codex-desktop.desktop" "GenericName=Codex Desktop"
    assert_contains "$REPO_DIR/contrib/user-local-install/files/.local/share/applications/codex-desktop.desktop" "Keywords=codex;chatgpt;openai;ai;coding;"
...
JS
    ...
    assert_contains "$extracted/webview/assets/index-test.js" 'case`linux-desktop`:case`general-settings`'
